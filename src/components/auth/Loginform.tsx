  ...
  return (
    <form action={handleSubmit} className="space-y-6 w-full max-w-md mx-auto p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">Inicia sesión para gestionar tus proyectos</p>
      </div>
      ...
      <p className="text-center text-sm text-gray-600">
        ¿No tienes cuenta? <Link href="/register" className="text-blue-600 font-semibold hover:underline">Regístrate aquí</Link>
      </p>
    </form>
  )
}